...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlInterpolatedYieldCurve(
        ...
        const ANY &MixedInterpolationBehavior,
        const ANY &NRateHelper,
        const sal_Int32 Permanent,
        const ANY &Trigger,
        const sal_Int32 Overwrite) throw(RuntimeException) {
    try {
        ...
        std::string MixedInterpolationBehaviorCpp;
        if(MixedInterpolationBehavior.hasValue()) 
            calcToScalar(MixedInterpolationBehaviorCpp, MixedInterpolationBehavior);
        else
            MixedInterpolationBehaviorCpp = "ShareRanges";

        long NRateHelperCpp;
        calcToScalar(NRateHelperCpp, NRateHelper);
        ...
        calcToScalar(NRateHelperLib, NRateHelper);
        ...
        QuantLib::MixedInterpolation::Behavior MixedInterpolationBehaviorEnum =
            ObjectHandler::Create<QuantLib::MixedInterpolation::Behavior>()(MixedInterpolationBehaviorCpp);
        ...
        boost::shared_ptr<ObjectHandler::Object> object(
            new QuantLibAddin::InterpolatedYieldCurve(
                ...
                TraitsIDCpp,
                InterpolatorIDCpp,
                MixedInterpolationBehaviorEnum,
                NRateHelperLib,
                PermanentCpp));
