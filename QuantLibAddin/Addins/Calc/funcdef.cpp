...
CalcAddins_impl::CalcAddins_impl() throw ()  {
    ...
    funcMap[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ]
        =  STRFROMANSI( "qlCalibrationHelperImpliedVolatility" );
    funcDesc[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ]
        =  STRFROMANSI( "Set the priging engine for the given SwaptionHelper object." );
    argName[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "id of existing QuantLib::CalibrationHelper object" ) );
    argName[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "TargetValue" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "target value." ) );
    argName[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "Accuracy" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "accuracy." ) );
    argName[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "MaxEvaluations" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "max evaluations." ) );
    argName[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "MinVol" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "min vol." ) );
    argName[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "MaxVol" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "max vol." ) );
    argName[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperImpliedVolatility" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlCalibrationHelperSetPricingEngine

    funcMap[ STRFROMANSI( "qlCalibrationHelperSetPricingEngine" ) ]
        =  STRFROMANSI( "qlCalibrationHelperSetPricingEngine" );
    funcDesc[ STRFROMANSI( "qlCalibrationHelperSetPricingEngine" ) ]
        =  STRFROMANSI( "Set the priging engine for the given SwaptionHelper object." );
    argName[ STRFROMANSI( "qlCalibrationHelperSetPricingEngine" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperSetPricingEngine" ) ].push_back( STRFROMANSI( "id of existing QuantLib::CalibrationHelper object" ) );
    argName[ STRFROMANSI( "qlCalibrationHelperSetPricingEngine" ) ].push_back( STRFROMANSI( "PricingEngine" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperSetPricingEngine" ) ].push_back( STRFROMANSI( "PricingEngine object ID." ) );
    argName[ STRFROMANSI( "qlCalibrationHelperSetPricingEngine" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlCalibrationHelperSetPricingEngine" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlModelG2Calibrate

    funcMap[ STRFROMANSI( "qlModelG2Calibrate" ) ]
        =  STRFROMANSI( "qlModelG2Calibrate" );
    funcDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ]
        =  STRFROMANSI( "calibrate a model." );
    argName[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "id of existing QuantLib::G2 object" ) );
    argName[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "CalibrationHelpers" ) );
    argDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "vector of calibration-helpers." ) );
    argName[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "Method" ) );
    argDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "OptimizationMethod object ID." ) );
    argName[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "EndCriteria" ) );
    argDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "EndCriteria object ID." ) );
    argName[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "Constraint" ) );
    argDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "Constraint." ) );
    argName[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "Weights" ) );
    argDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "weights. Default value = ." ) );
    argName[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "FixedCoeff" ) );
    argDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "TRUE if the i-th coefficient must be kept fixed in later calibrations, FALSE otherwise. Default value = ." ) );
    argName[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlModelG2Calibrate" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlOneFactorAffineModelCalibrate

    funcMap[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ]
        =  STRFROMANSI( "qlOneFactorAffineModelCalibrate" );
    funcDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ]
        =  STRFROMANSI( "calibrate a model." );
    argName[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "id of existing QuantLib::OneFactorAffineModel object" ) );
    argName[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "CalibrationHelpers" ) );
    argDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "vector of calibration-helpers." ) );
    argName[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "Method" ) );
    argDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "OptimizationMethod object ID." ) );
    argName[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "EndCriteria" ) );
    argDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "EndCriteria object ID." ) );
    argName[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "Constraint" ) );
    argDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "Constraint." ) );
    argName[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "Weights" ) );
    argDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "weights. Default value = ." ) );
    argName[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "FixedCoeff" ) );
    argDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "TRUE if the i-th coefficient must be kept fixed in later calibrations, FALSE otherwise. Default value = ." ) );
    argName[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlOneFactorAffineModelCalibrate" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlSwaptionHelper

    funcMap[ STRFROMANSI( "qlSwaptionHelper" ) ]
        =  STRFROMANSI( "qlSwaptionHelper" );
    funcDesc[ STRFROMANSI( "qlSwaptionHelper" ) ]
        =  STRFROMANSI( "Construct an object of class SwaptionHelper and return its id" );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "OptionTenor" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "option tenor as Period (e.g. '5Y')." ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "Length" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "option length." ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "Volatility" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "volatility quote." ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "IborIndex" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "IborIndex object ID." ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "FixedLegTenor" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "fixed leg tenor." ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "FixedLegDayCounter" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "fixed leg day-counter." ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "FloatingLegDayCounter" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "floating leg day-counter." ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "YieldCurve" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "YieldTermStructure object ID." ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelper" ) ].push_back( STRFROMANSI( "overwrite flag" ) );

    // qlSwaptionHelperModelValue

    funcMap[ STRFROMANSI( "qlSwaptionHelperModelValue" ) ]
        =  STRFROMANSI( "qlSwaptionHelperModelValue" );
    funcDesc[ STRFROMANSI( "qlSwaptionHelperModelValue" ) ]
        =  STRFROMANSI( "Set the priging engine for the given SwaptionHelper object." );
    argName[ STRFROMANSI( "qlSwaptionHelperModelValue" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelperModelValue" ) ].push_back( STRFROMANSI( "id of existing QuantLib::SwaptionHelper object" ) );
    argName[ STRFROMANSI( "qlSwaptionHelperModelValue" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlSwaptionHelperModelValue" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    ...
    argName[ STRFROMANSI( "qlConstantOptionletVolatility" ) ].push_back( STRFROMANSI( "VolatilityType" ) );
    argDesc[ STRFROMANSI( "qlConstantOptionletVolatility" ) ].push_back( STRFROMANSI( "Volatility type: Normal or ShiftedLognormal. Default value = ShiftedLognormal." ) );
    argName[ STRFROMANSI( "qlConstantOptionletVolatility" ) ].push_back( STRFROMANSI( "Displacement" ) );
    argDesc[ STRFROMANSI( "qlConstantOptionletVolatility" ) ].push_back( STRFROMANSI( "Shift for the lognormal model. Default value = 0.00." ) );
    ...
    funcMap[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ]
        =  STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" );
    funcDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ]
        =  STRFROMANSI( "Construct an object of class PiecewiseYieldCurve and return its id" );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "NDays" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "number of days to advance from EvaluationDate (usually zero or two): it fixes the date at which the discount factor = 1.0. Default value = 0." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Calendar" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "holiday calendar (e.g. TARGET) to advance from global EvaluationDate." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "RateHelpers" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "vector of rate-helpers." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "DayCounter" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "DayCounter ID. Default value = Actual/365 (Fixed)." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Jumps" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Jump quotes vector." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "JumpDates" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Jump dates vector." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Accuracy" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Bootstrapping accuracy. Default value = 1.0e-12." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "TraitsID" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Discount, ZeroRate, or ForwardRate. Default value = Discount." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "InterpolatorID" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "BackwardFlat, ForwardFlat, Linear, LogLinear, CubicSpline, or LogCubic. Default value = LogLinear." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "MixedInterpolationBehavior" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "ShareRanges to join two different interpolations over all the pillars, SplitRanges otherwise. Default value = ShareRanges." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "PillarsBeforeChange" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Number of pillars before the interpolation change." ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlPiecewiseYieldCurveMixedInterpolation" ) ].push_back( STRFROMANSI( "overwrite flag" ) );
    ...
    funcMap[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ]
        =  STRFROMANSI( "qlBachelierCapFloorEngine" );
    funcDesc[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ]
        =  STRFROMANSI( "Construct an object of class BachelierCapFloorEngine and return its id" );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "YieldCurve" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "discounting YieldTermStructure object ID." ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "VolTS" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "OptionletVolatilityStructure object ID." ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine" ) ].push_back( STRFROMANSI( "overwrite flag" ) );

    // qlBachelierCapFloorEngine2

    funcMap[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ]
        =  STRFROMANSI( "qlBachelierCapFloorEngine2" );
    funcDesc[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ]
        =  STRFROMANSI( "Construct an object of class BachelierCapFloorEngine and return its id" );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "YieldCurve" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "discounting YieldTermStructure object ID." ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "Vol" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "Term (i.e. flat) volatility." ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "DayCounter" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "DayCounter ID. Default value = Actual/365 (Fixed)." ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlBachelierCapFloorEngine2" ) ].push_back( STRFROMANSI( "overwrite flag" ) );
    ...
    argDesc[ STRFROMANSI( "qlBlackSwaptionEngine2" ) ].push_back( STRFROMANSI( "swaption Black volatility." ) );
    ...
    funcMap[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ]
        =  STRFROMANSI( "qlJamshidianSwaptionEngine" );
    funcDesc[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ]
        =  STRFROMANSI( "Construct an object of class JamshidianSwaptionEngine and return its id" );
    argName[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "Model" ) );
    argDesc[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "Model object ID." ) );
    argName[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "YieldCurve" ) );
    argDesc[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "yield term structure object ID. Default value = ." ) );
    argName[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlJamshidianSwaptionEngine" ) ].push_back( STRFROMANSI( "overwrite flag" ) );

    // qlModelG2SwaptionEngine

    funcMap[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ]
        =  STRFROMANSI( "qlModelG2SwaptionEngine" );
    funcDesc[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ]
        =  STRFROMANSI( "Construct an object of class G2SwaptionEngine and return its id" );
    argName[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "Model" ) );
    argDesc[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "G2 Model object ID." ) );
    argName[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "Range" ) );
    argDesc[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "Range." ) );
    argName[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "Intervals" ) );
    argDesc[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "Intervals." ) );
    argName[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlModelG2SwaptionEngine" ) ].push_back( STRFROMANSI( "overwrite flag" ) );
    ...
    funcMap[ STRFROMANSI( "qlTreeSwaptionEngine" ) ]
        =  STRFROMANSI( "qlTreeSwaptionEngine" );
    funcDesc[ STRFROMANSI( "qlTreeSwaptionEngine" ) ]
        =  STRFROMANSI( "Construct an object of class TreeSwaptionEngine and return its id" );
    argName[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "Model" ) );
    argDesc[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "Model object ID." ) );
    argName[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "Nsteps" ) );
    argDesc[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "Number of time steps." ) );
    argName[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "YieldCurve" ) );
    argDesc[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "yield term structure object ID. Default value = ." ) );
    argName[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlTreeSwaptionEngine" ) ].push_back( STRFROMANSI( "overwrite flag" ) );
    ...
    argName[ STRFROMANSI( "qlFraRateHelper" ) ].push_back( STRFROMANSI( "PillarDate" ) );
    argDesc[ STRFROMANSI( "qlFraRateHelper" ) ].push_back( STRFROMANSI( "Pillar date can be: MaturityDate, LastRelevantDate or CustomDate. Default value = MaturityDate." ) );
    argName[ STRFROMANSI( "qlFraRateHelper" ) ].push_back( STRFROMANSI( "CustomPillarDate" ) );
    argDesc[ STRFROMANSI( "qlFraRateHelper" ) ].push_back( STRFROMANSI( "Custom Pillar Date. Default value = QuantLib::Date()." ) );
    ...
    argName[ STRFROMANSI( "qlFraRateHelper2" ) ].push_back( STRFROMANSI( "PillarDate" ) );
    argDesc[ STRFROMANSI( "qlFraRateHelper2" ) ].push_back( STRFROMANSI( "Pillar date can be: MaturityDate, LastRelevantDate or CustomDate. Default value = MaturityDate." ) );
    argName[ STRFROMANSI( "qlFraRateHelper2" ) ].push_back( STRFROMANSI( "CustomPillarDate" ) );
    argDesc[ STRFROMANSI( "qlFraRateHelper2" ) ].push_back( STRFROMANSI( "Custom Pillar Date. Default value = QuantLib::Date()." ) );
    ...
    funcMap[ STRFROMANSI( "qlFxSwapRateHelper" ) ]
        =  STRFROMANSI( "qlFxSwapRateHelper" );
    funcDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ]
        =  STRFROMANSI( "Construct an object of class FxSwapRateHelper and return its id" );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "FwdPoint" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "forward point quote." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "SpotFx" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "fx spot quote." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "Tenor" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "fx swap length (e.g. 3M for three months)." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "FixingDays" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "fixing days (e.g. 2)." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "Calendar" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "holiday calendar (e.g. TARGET)." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "Convention" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "business day convention (e.g. Modified Following)." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "EndOfMonth" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "End of Month rule (TRUE for end of month to end of month termination date, FALSE otherwise)." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "IsFxBaseCurrencyCollateralCurrency" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "TRUE if the base currency of the fx currency pair is the one used as collateral, FALSE otherwise." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "CollateralCurve" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "collateral YieldTermStructure object ID." ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlFxSwapRateHelper" ) ].push_back( STRFROMANSI( "overwrite flag" ) );
    ...
    funcMap[ STRFROMANSI( "qlRateHelperLatestRelevantDate" ) ]
        =  STRFROMANSI( "qlRateHelperLatestRelevantDate" );
    funcDesc[ STRFROMANSI( "qlRateHelperLatestRelevantDate" ) ]
        =  STRFROMANSI( "returns the latest relevant date for the given RateHelper object." );
    argName[ STRFROMANSI( "qlRateHelperLatestRelevantDate" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlRateHelperLatestRelevantDate" ) ].push_back( STRFROMANSI( "id of existing QuantLib::RateHelper object" ) );
    argName[ STRFROMANSI( "qlRateHelperLatestRelevantDate" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlRateHelperLatestRelevantDate" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlRateHelperMaturityDate

    funcMap[ STRFROMANSI( "qlRateHelperMaturityDate" ) ]
        =  STRFROMANSI( "qlRateHelperMaturityDate" );
    funcDesc[ STRFROMANSI( "qlRateHelperMaturityDate" ) ]
        =  STRFROMANSI( "returns the maturity date for the given RateHelper object." );
    argName[ STRFROMANSI( "qlRateHelperMaturityDate" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlRateHelperMaturityDate" ) ].push_back( STRFROMANSI( "id of existing QuantLib::RateHelper object" ) );
    argName[ STRFROMANSI( "qlRateHelperMaturityDate" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlRateHelperMaturityDate" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlRateHelperPillarDate

    funcMap[ STRFROMANSI( "qlRateHelperPillarDate" ) ]
        =  STRFROMANSI( "qlRateHelperPillarDate" );
    funcDesc[ STRFROMANSI( "qlRateHelperPillarDate" ) ]
        =  STRFROMANSI( "returns the pillar date for the given RateHelper object." );
    argName[ STRFROMANSI( "qlRateHelperPillarDate" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlRateHelperPillarDate" ) ].push_back( STRFROMANSI( "id of existing QuantLib::RateHelper object" ) );
    argName[ STRFROMANSI( "qlRateHelperPillarDate" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlRateHelperPillarDate" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    ...
    argName[ STRFROMANSI( "qlSwapRateHelper" ) ].push_back( STRFROMANSI( "PillarDate" ) );
    argDesc[ STRFROMANSI( "qlSwapRateHelper" ) ].push_back( STRFROMANSI( "Pillar date can be: MaturityDate, LastRelevantDate or CustomDate. Default value = MaturityDate." ) );
    argName[ STRFROMANSI( "qlSwapRateHelper" ) ].push_back( STRFROMANSI( "CustomPillarDate" ) );
    argDesc[ STRFROMANSI( "qlSwapRateHelper" ) ].push_back( STRFROMANSI( "Custom Pillar Date. Default value = QuantLib::Date()." ) );
    ...
    argName[ STRFROMANSI( "qlSwapRateHelper2" ) ].push_back( STRFROMANSI( "PillarDate" ) );
    argDesc[ STRFROMANSI( "qlSwapRateHelper2" ) ].push_back( STRFROMANSI( "Pillar date can be: MaturityDate, LastRelevantDate or CustomDate. Default value = MaturityDate." ) );
    argName[ STRFROMANSI( "qlSwapRateHelper2" ) ].push_back( STRFROMANSI( "CustomPillarDate" ) );
    argDesc[ STRFROMANSI( "qlSwapRateHelper2" ) ].push_back( STRFROMANSI( "Custom Pillar Date. Default value = QuantLib::Date()." ) );
    ...
    funcMap[ STRFROMANSI( "qlModelG2" ) ]
        =  STRFROMANSI( "qlModelG2" );
    funcDesc[ STRFROMANSI( "qlModelG2" ) ]
        =  STRFROMANSI( "Construct an object of class G2 and return its id" );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "id of object to be created" ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "YieldCurve" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "YieldTermStructure object ID." ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "A" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "drift of x(t) dynamics with r(t)= x(t) + y(t). Default value = 0.1." ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "Sigma" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "volatility of x(t) dynamics with r(t)= x(t) + y(t). Default value = 0.01." ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "B" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "drift of y(t) dynamics with r(t)= x(t) + y(t). Default value = 0.1." ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "Eta" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "volatility of y(t) dynamics with r(t)= x(t) + y(t). Default value = 0.01." ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "Correlation" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "Correlation between x(t) and y(t) Default value = -0.75." ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "Permanent" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "object permanent/nonpermanent" ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    argName[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "Overwrite" ) );
    argDesc[ STRFROMANSI( "qlModelG2" ) ].push_back( STRFROMANSI( "overwrite flag" ) );

    // qlModelG2A

    funcMap[ STRFROMANSI( "qlModelG2A" ) ]
        =  STRFROMANSI( "qlModelG2A" );
    funcDesc[ STRFROMANSI( "qlModelG2A" ) ]
        =  STRFROMANSI( "returns the drift of x(t) dynamics with r(t) = x(t) + y(t)." );
    argName[ STRFROMANSI( "qlModelG2A" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlModelG2A" ) ].push_back( STRFROMANSI( "id of existing QuantLib::G2 object" ) );
    argName[ STRFROMANSI( "qlModelG2A" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlModelG2A" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlModelG2B

    funcMap[ STRFROMANSI( "qlModelG2B" ) ]
        =  STRFROMANSI( "qlModelG2B" );
    funcDesc[ STRFROMANSI( "qlModelG2B" ) ]
        =  STRFROMANSI( "returns the drift of y(t) dynamics with r(t) = x(t) + y(t)." );
    argName[ STRFROMANSI( "qlModelG2B" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlModelG2B" ) ].push_back( STRFROMANSI( "id of existing QuantLib::G2 object" ) );
    argName[ STRFROMANSI( "qlModelG2B" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlModelG2B" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlModelG2eta

    funcMap[ STRFROMANSI( "qlModelG2eta" ) ]
        =  STRFROMANSI( "qlModelG2eta" );
    funcDesc[ STRFROMANSI( "qlModelG2eta" ) ]
        =  STRFROMANSI( "returns the volatility of y(t) dynamics with r(t) = x(t) + y(t)." );
    argName[ STRFROMANSI( "qlModelG2eta" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlModelG2eta" ) ].push_back( STRFROMANSI( "id of existing QuantLib::G2 object" ) );
    argName[ STRFROMANSI( "qlModelG2eta" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlModelG2eta" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlModelG2rho

    funcMap[ STRFROMANSI( "qlModelG2rho" ) ]
        =  STRFROMANSI( "qlModelG2rho" );
    funcDesc[ STRFROMANSI( "qlModelG2rho" ) ]
        =  STRFROMANSI( "returns the correlation between x(t) and y(t) with r(t) = x(t) + y(t)." );
    argName[ STRFROMANSI( "qlModelG2rho" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlModelG2rho" ) ].push_back( STRFROMANSI( "id of existing QuantLib::G2 object" ) );
    argName[ STRFROMANSI( "qlModelG2rho" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlModelG2rho" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlModelG2sigma

    funcMap[ STRFROMANSI( "qlModelG2sigma" ) ]
        =  STRFROMANSI( "qlModelG2sigma" );
    funcDesc[ STRFROMANSI( "qlModelG2sigma" ) ]
        =  STRFROMANSI( "returns the volatility of x(t) dynamics with r(t) = x(t) + y(t)." );
    argName[ STRFROMANSI( "qlModelG2sigma" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlModelG2sigma" ) ].push_back( STRFROMANSI( "id of existing QuantLib::G2 object" ) );
    argName[ STRFROMANSI( "qlModelG2sigma" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlModelG2sigma" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    ...
    argName[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "R0" ) );
    argDesc[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "initial value. Default value = 0.05." ) );
    argName[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "A" ) );
    argDesc[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "mean reverting speed. Default value = 0.1." ) );
    argName[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "B" ) );
    argDesc[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "short-rate limit value. Default value = 0.05." ) );
    argName[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "Sigma" ) );
    argDesc[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "volatility. Default value = 0.01." ) );
    argName[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "Lambda" ) );
    argDesc[ STRFROMANSI( "qlVasicek" ) ].push_back( STRFROMANSI( "risk premium. Default value = 0.0." ) );
    ...
    funcMap[ STRFROMANSI( "qlVasicekA" ) ]
        =  STRFROMANSI( "qlVasicekA" );
    funcDesc[ STRFROMANSI( "qlVasicekA" ) ]
        =  STRFROMANSI( "returns mean reverting speed a, with dr(t) = a(b-r(t))dt + sigma dW(t)." );
    argName[ STRFROMANSI( "qlVasicekA" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlVasicekA" ) ].push_back( STRFROMANSI( "id of existing QuantLib::Vasicek object" ) );
    argName[ STRFROMANSI( "qlVasicekA" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlVasicekA" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlVasicekB

    funcMap[ STRFROMANSI( "qlVasicekB" ) ]
        =  STRFROMANSI( "qlVasicekB" );
    funcDesc[ STRFROMANSI( "qlVasicekB" ) ]
        =  STRFROMANSI( "returns short-rate limit value b, with dr(t) = a(b-r(t))dt + sigma dW(t)." );
    argName[ STRFROMANSI( "qlVasicekB" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlVasicekB" ) ].push_back( STRFROMANSI( "id of existing QuantLib::Vasicek object" ) );
    argName[ STRFROMANSI( "qlVasicekB" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlVasicekB" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlVasicekLambda

    funcMap[ STRFROMANSI( "qlVasicekLambda" ) ]
        =  STRFROMANSI( "qlVasicekLambda" );
    funcDesc[ STRFROMANSI( "qlVasicekLambda" ) ]
        =  STRFROMANSI( "returns the risk premium." );
    argName[ STRFROMANSI( "qlVasicekLambda" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlVasicekLambda" ) ].push_back( STRFROMANSI( "id of existing QuantLib::Vasicek object" ) );
    argName[ STRFROMANSI( "qlVasicekLambda" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlVasicekLambda" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );

    // qlVasicekSigma

    funcMap[ STRFROMANSI( "qlVasicekSigma" ) ]
        =  STRFROMANSI( "qlVasicekSigma" );
    funcDesc[ STRFROMANSI( "qlVasicekSigma" ) ]
        =  STRFROMANSI( "returns the volatility sigma, with dr(t) = a(b-r(t))dt + sigma dW(t)." );
    argName[ STRFROMANSI( "qlVasicekSigma" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlVasicekSigma" ) ].push_back( STRFROMANSI( "id of existing QuantLib::Vasicek object" ) );
    argName[ STRFROMANSI( "qlVasicekSigma" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlVasicekSigma" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    ...
    argDesc[ STRFROMANSI( "qlSwaption" ) ].push_back( STRFROMANSI( "settlement type (Physical, Cash)." ) );
    ...
    argName[ STRFROMANSI( "qlInterpolatedYieldCurve" ) ].push_back( STRFROMANSI( "MixedInterpolationBehavior" ) );
    argDesc[ STRFROMANSI( "qlInterpolatedYieldCurve" ) ].push_back( STRFROMANSI( "ShareRanges to join two different interpolations over all the pillars, SplitRanges otherwise. Default value = ShareRanges." ) );
    argName[ STRFROMANSI( "qlInterpolatedYieldCurve" ) ].push_back( STRFROMANSI( "NRateHelper" ) );
    argDesc[ STRFROMANSI( "qlInterpolatedYieldCurve" ) ].push_back( STRFROMANSI( "Number of pillar from which change the interpolation ID. Default value = 1." ) );
